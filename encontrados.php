...
<html>
    ...
    <body class="hold-transition skin-blue-light fixed sidebar-mini">
                        ...
                        <div id="plantilla" style="display:none">
                            <div class="col-sm-4 col-md-3" >
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h4 class="text-center titulo">Encontrado</h4>
                                        <p><span class="label label-success estado">Encontrado</span><span class="fecha pull-right">12/05/2017</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script type="text/javascript" src="js/encontrados.js"></script>

...
class Adopcion {
    ...
    public function listarDataTable($postData) {
        ...
        $aColumns = array('id', 'imagen', 'nombre', 'usuario', 'fecha', 'estado', 'tipo_mascota', 'sexo', 'ano_nacimiento', 'dni', 'direccion', 'referencia', 'resultado', 'id_test', 'id_visita_adopcion','fecha_adopcion','hora_adopcion','descripcion_adopcion', "telefono", "celular", "ciudad", "ocupacion", "id_horario", "id_mascota");
        $sIndexColumn = 'id';
        $sTable = 'v_adopcion';
